About ipysheet-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipysheet-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2610&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipysheet-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipysheet` can be installed with `conda`:
...
```
mamba install ipysheet
```

It is possible to list all of the versions of `ipysheet` available on your platform with `conda`:
...
```
mamba search ipysheet --channel conda-forge
```
...
mamba repoquery search ipysheet --channel conda-forge

# List packages depending on `ipysheet`:
mamba repoquery whoneeds ipysheet --channel conda-forge

# List dependencies of `ipysheet`:
mamba repoquery depends ipysheet --channel conda-forge
```
